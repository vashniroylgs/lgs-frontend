        ...
        <div className="cosultant-main-contianer">
          <div className="cosultant-heading-contianer">
            <div className="consultant-data-container">
              ...
              <p className="consultant-description">
                ...
                and strategically to provide valuable insights that lead to the
                best solutions. Their commitment to excellence inspires us all
                to strive for greatness in everything we do.
              </p>
            </div>
            <div>
            <img
          ...
          <div>
            ...
            <p className="consultant-description">
              ...
              help drive more productive and collaborative development, enabling
              organizations to build applications that meet specific customer
              needs within the framework.
            </p>
          </div>
          <div className="mendix-cards-container">
            <div className="mendix-card">
              ...
              <p className="consultant-cards-description">
                ...
                advanced features. They prioritize speed and agility, aiming to
                create functional applications with minimal effort and coding.
              </p>
            </div>
            <div className="mendix-card">
              <img className="mendix-icon" src={Rapid} />
              <h6 className="consultant-cards-headings">Mendix Intermediate</h6>
              <p className="consultant-cards-description">
                Intermediate developers possess a greater understanding of the
                platform, having progressed beyond initial stages of developing
                simple applications. They can build more complex applications,
                leveraging the platform's capabilities to include custom logic
              </p>
            </div>
            <div className="mendix-card">
              <img className="mendix-icon" src={Rapid} />
              ...
              <p className="consultant-cards-description">
                Mendix advanced developers have progressed beyond the basics and
                are proficient in using advanced features and techniques to
                create innovative solutions. Our developers can implement
          ...
          <div>
            ...
            <p className="consultant-description">
              ...
              in customizing, implementing, and optimizing software development
              and testing processes for organizations. We tailor the Polarion
              platform to meet the specific needs of each organization by
              configuring work items, workflows, fields, templates, and
              dashboards to match their software development processes and
              methodologies.
            </p>
          </div>
          <div className="mendix-cards-container">
            <div className="mendix-card">
              ...
              <p className="consultant-cards-description">
                Our polarion developers play a crucial role in working with this
                platform to customize, implement, and optimize software
                development and testing processes within organizations. They
                customize the Polarion platform to align with an organization's
                specific needs.
              </p>
            </div>
            <div className="mendix-card">
              ...
              <p className="consultant-cards-description">
                Through customization, the client’s experience with the software
                will help the requirement goals more efficiently. We follow
                customization steps where we gather requirements, objects based
                on our client’s requirements. Engage in discussions with key
                stakeholders to identify the specific features
              </p>
            </div>
            <div className="mendix-card">
              <img className="mendix-icon" src={Rapid} />
          ...
          <div className="salesconsultant-main-container">
            ...
            <div className="salesconsultant-data-container">
              <p className="consultant-description">
                ...
                today’s fast-paced business landscape. It helps clients to focus
                on what matters most: delivering value to their customers and
                driving business success. At LGS, we have a team of certified
                experts in Sales Force Administration and Development. Our
                professionals possess the necessary expertise to effectively
                manage and configure the Salesforce platform to meet the
          ...
          <div className="consultant-frontend-main-contianer consultant-frontend-main-mbl-contianer">
            <div className="consultant-data-container">
              <h2 className="consultant-side-headings">Frontend Developers</h2>

              <p className="consultant-description">
                LGS is home to highly proficient designers who excel in creating
                inventive designs for the frontend part of an application. They
                are expertise at implementing animations, transitions, and
                interactive elements to enhance user engagement and make the
                user interface visually appealing. They are skilled in using
                technologies like HTML, CSS, JavaScript, and React JS. Our
                commitment is to deliver a website crafted with organized,
          ...
          <div className="consultant-frontend-main-contianer consultant-backend-main-mbl-contianer">
            ...
            <div className="consultant-data-container">
              ...
              <p className="consultant-description">
                ...
                experienced backend developers are capable of handling database
                management, API development, server configuration, and system
                integration. They ensure data integrity and seamless
                communication between different components. Our developers are
                proficient in programming languages such as Python and Java, and
                they have a solid understanding of relational databases like
                MySQL, PostgreSQL, as well as NoSQL databases like Mongo DB.
                <Link to="/contactus">KnowMore</Link>
              </p>
              <h5 className="consultant-quoutes">
          ...
          <div className="consultant-frontend-main-contianer consultant-mobile-main-mbl-contianer">
            <div className="consultant-data-container">
              ...
              <p className="consultant-description">
                As we see, Innovations in mobile application has revolutionized
                IT industry. Embrace the power of mobile apps to transform
                business, enhance user experiences, and drive growth. Our group
                has over 7+ skilled developers who are experts in creating
                mobile apps, keeping them running smoothly, and providing
                support. We're also great at making projects happen.
                <Link to="/contactus">KnowMore</Link>
              </p>
              <h5 className="consultant-quoutes">
          ...
          <div className="consultant-frontend-main-contianer consultant-software-main-mbl-contianer">
            ...
            <div className="consultant-data-container">
              ...
              <p className="consultant-description">
                ...
                testing, and deployment. We like to use Agile methodologies such
                as Scrum and Kanban, which help us work efficiently and good at
                writing clean code and implementing CI/CD practices. Development
                team is passionate about creating applications and tools that
