    ...
    <div className="mbl-nav-items-container">
      <ul className="mbl-nav-menu">
        <Link to="/" className="nav-link" >
          ...
          <li className="nav-mbl-service-container nav-mbl-menu-item">PRODUCTS
              <ul className="mbl-Nav-Service-container-items">
                <Link to="/polarianalm" className="link">
                    <li className="mbl-product-items">Polarion ALM</li>
                </Link>
                <Link to="/saascloudsolutions" className="link">
                    <li className="mbl-product-items">SAAS & cloud Solutions</li>
                </Link>
                <Link to="/mobileandappdevelopment" className="link">
                    <li className="mbl-product-items">Mobile & APP Development</li>
                </Link>
                <Link to="/resellermendix" className="link">
                    <li className="mbl-product-items">Mendix</li>
                </Link>
                <Link to="/salesforcepage" className="link">
                    <li className="mbl-product-items">Sales Force</li>
                </Link>
                <Link to="/salesforcepage" className="link">
                    <li className="mbl-product-items">Quanta Genius</li>
                </Link>
                <Link to="/salesforcepage" className="link">
                    <li className="mbl-product-items">Taxoguru Consulting</li>
                </Link>
                <Link to="/salesforcepage" className="link">
                    <li className="mbl-product-items">Purple Labs</li>
                </Link>
                <Link to="/salesforcepage" className="link">
                    <li className="mbl-product-items">Finesse Computer Solutions</li>
                </Link>
                <Link to="/salesforcepage" className="link">
                    <li className="mbl-product-items">SRM 360 Degree Consulting</li>
                </Link>
                <Link to="/salesforcepage" className="link">
                    <li className="mbl-product-items">Glorious Mindmine</li>
                </Link>
              </ul>
        ...
        <Link
          ...
          className="nav-link"
        >
          <li className="nav-mbl-service-container nav-mbl-menu-item">TECHNOLOGIES
            <ul className="mbl-Nav-Service-container-items technology-overflow">
                  ...
                  <div>
                      ...
                      <div>
                          <h6 className="Nav-Mbl-teachnology-main-heading">CLOUD COMPUTING</h6>
                          ...
                          <ul className="Nav-Mbl-technology-sub-container-items">
                            ...
                            <Link to="" className="link">
                                      <li className="mbl-product-items">DEPLOYMENT AUTOMATION SUPPORT</li>
                            </Link>
                          </ul>
                      </div>
                      <div>
                          <h6 className="Nav-Mbl-teachnology-main-heading">SERVER SIDE SCRIPTING</h6>
                          <ul className="Nav-Mbl-technology-sub-container-items">
                            <Link to="" className="link">
                                    <li className="mbl-product-items">PHP</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="mbl-product-items">J2EE, J2SE, SWING, SERVLET</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="mbl-product-items">SPRING, STRUTS, HIBERNATE</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="mbl-product-items">JSP, JSF, APACHECXF</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="mbl-product-items">JUNIT, TESTING, MOCKITO</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="mbl-product-items">MICROSOFT VISIO, ENTERPRISE ARCHITECT</li>
                            </Link>
                            <Link to="" className="link">
                      ...
                      <div>
                        <h6 className="Nav-Mbl-teachnology-main-heading">DATA MINING & ANALYTICS</h6>
                        <ul className="Nav-Mbl-technology-sub-container-items">
                          <Link to="" className="link">
                                    <li className="mbl-product-items">DATA BASE DESIGN: ORACLE</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="mbl-product-items">SQL DATABASE</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="mbl-product-items">DATABASE DEVELOPMENT MONGO DBE</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="mbl-product-items">DATABASE CONSULTING SQL SERVER</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="mbl-product-items">DATABASE CONSULTING SQL SERVER</li>
                          </Link>
                        </ul>
                        <h6 className="Nav-Mbl-teachnology-main-heading">WEB SERVER TECHNOLOGY</h6>
                          <ul className="Nav-Mbl-technology-sub-container-items">
                            <Link to="" className="link">
                        ...
                        <div>
                            <h6 className="Nav-Mbl-teachnology-main-heading">LOW CODE PLATFORM</h6>
                            <ul className="Nav-Mbl-technology-sub-container-items">
                                <Link to="" className="link">
                                        <li className="mbl-product-items">MENDIX</li>
                                </Link>
                            ...
                            <div>
                            <h6 className="Nav-Mbl-teachnology-main-heading">APPLICATION LIFECYCLE MANAGEMENT TOOL</h6>
                            <ul className="Nav-Mbl-technology-sub-container-items">
                                <Link to="" className="link">
                            ...
                            <div>
                            <h6 className="Nav-Mbl-teachnology-main-heading">CRM SOFTWARE</h6>
                            <ul className="Nav-Mbl-technology-sub-container-items">
                                <Link to="" className="link">
        ...
        <li className="nav-mbl-service-container nav-mbl-menu-item">
            ...
            <ul className="mbl-Nav-Service-container-items">
                    ...
                    <Link to="/mobileandappdevelopmen" className="link">
                         <li className="mbl-product-items">Web Development</li>
                    </Link>
                    <Link to="/resellermendix" className="link">
                        <li className="mbl-product-items">Mendix</li>
                    </Link>
                    ...
                    <Link to="/ptcintegrity" className="link">
                        <li className="mbl-product-items">PTC Integrity</li>
                    </Link>
                    <Link to="/salesforcepage" className="link">
                        <li className="mbl-product-items">Sales Force</li>
                    </Link>
                    ...
                    <Link to="/" className="link">
                        <li className="mbl-product-items">Digital Marketing</li>
                    </Link>
            </ul>
          ...
          <div className="nav-bar-large-container">
            ...
            <li className="Nav-Service-container nav-menu-item home-padding">
              ...
              <li className="Nav-Service-container nav-menu-item technology-item">
                    ...
                    <ul className="Nav-Service-container-items nav-service-flex-contianer ">
                      <div className="nav-service-flex-contianer-items">
                          <h6 className="Nav-teachnology-main-heading">ONLINE MARKETING</h6>
                          <ul className="Nav-technology-sub-container-items">
                          <Link to="" className="link">
                                  <li className="Nav-technology-item">SEO SERVICES</li>
                            </Link>
                            <Link to="" className="link">
                                  <li className="Nav-technology-item">SEARCH ENGINE MARKETING</li>
                            </Link>
                            <Link to="" className="link">
                                  <li className="Nav-technology-item">LEAD MANAGEMENT SYSTEM</li>
                            </Link>
                            <Link to="" className="link">
                      ...
                      <div className="nav-service-flex-contianer-items">
                          ...
                          <ul className="Nav-technology-sub-container-items">
                          <Link to="" className="link">
                                  <li className="Nav-technology-item">MENDIX SOLUTION CONSULTANT</li>
                          </Link>
                          <Link to="" className="link">
                                  <li className="Nav-technology-item">POLARION SOLUTION CONSULTANT</li>
                          </Link>
                          <Link to="" className="link">
                                  <li className="Nav-technology-item">SALESFORCE SOLUTION CONSULTANT</li>
                          </Link>
                          <Link to="" className="link">
                                  <li className="Nav-technology-item">CONVENTIONAL DEVELOPMENT CONSULTANT</li>
                          </Link>
                          </ul>
                      ...
                      <div className="nav-service-flex-contianer-items">
                          <h6 className="Nav-teachnology-main-heading">WEB DESIGN & DEVELOPMENT</h6>
                          <ul className="Nav-technology-sub-container-items">
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">WEBSITE DESIGN</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">WEBSITE DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">CRM SOFTWARE DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">EDUCATIONAL WEB PORTAL DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">RESTAURANT WEB PORTAL DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">E-COMMERCE WEBSITE DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">HEALTHCARE PORTAL DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">REAL ESTATE PORTAL DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">LEARNING MANAGEMENT SYSTEM DEVELOPMENT</li>
                            </Link>
                            <Link to="" className="link">
                                    <li className="Nav-technology-item">TAXATION PORTAL DEVELOPMENT</li>
                            </Link>
                          </ul>
                      </div>
                      <div className="nav-service-flex-contianer-items">
                        <h6 className="Nav-teachnology-main-heading">MOBILE APPLICATION</h6>
                        <ul className="Nav-technology-sub-container-items">
                          <Link to="" className="link">
                                    <li className="Nav-technology-item">MOBILE APP DEVELOPMENT</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="Nav-technology-item">WINDOWS APP DEVELOPMENT</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="Nav-technology-item">XAMARIN APP DEVELOPMENT</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="Nav-technology-item">HYBRID APP DEVELOPMENT	</li>
                          </Link>
                          <Link to="" className="link">
                                    <li className="Nav-technology-item">NATIVE APP  DEVELOPMENT	</li>
                          </Link>
                        </ul>
                        <h6 className="Nav-teachnology-main-heading">CREATIVE DESIGN</h6>
                          <ul className="Nav-technology-sub-container-items">
                            <Link to="" className="link">
              ...
              <Link to="/careers" className="nav-link">
                ...
                <li className="Nav-Reseller-container nav-menu-item career-padding">RESELLER
              ...
              <Link
                to="/aboutus"
                className="nav-link">
                <li className="nav-menu-item about-us-nav about-padding">ABOUT US</li>
              </Link>
              <Link
                to="/contactus"
                className="nav-link">
                <li className="nav-menu-item about-us-nav about-padding">CONTACT US</li>
              </Link>
            </ul>
          </div>
        </div>
