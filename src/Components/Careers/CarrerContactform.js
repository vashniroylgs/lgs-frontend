...
const ContactForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const requiredFields = ['career_name', 'career_phone', 'career_total_exp', 'career_job_change', 'career_email', 'career_relevant_exp', 'career_current_ctc', 'career_exp_ctc', 'career_notice_period', 'attach_document'];
