...
const ContactPage = () => {
  ...
  const [servicesFirstName, setservicesFirstName] = useState("");
  const [serviesLastName, setserviesLastName] = useState("");
  const [servicesBusinessEmail, setservicesBusinessEmail] = useState("");
  ...
  const submitContactServices = async (e) => {
    ...
    const servicesformData = {
      servicesFirstName,
      serviesLastName,
      servicesBusinessEmail,
      servicesMessage,
    };
    console.log(servicesformData);
    try {
      const response = await fetch("/contactservices", {
        method: "POST",
        headers: {
  ...
  const submitContactQueries = async (e) => {
    ...
    try {
      const queryresponse = await fetch("/contactqueries", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
