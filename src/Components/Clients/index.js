...
const careerPageDetails = [
  ...
  },
  {
    ...
    button: "HPCL",
    companyLogo: "https://res.cloudinary.com/dcczhcvjg/image/upload/v1690970768/HINDPETRO.NS-6dfea446_vzf5in.png",

  },
  {
    companyName: "MRPL",
    Description: "Mangalore Refinery and Petrochemicals Limited (MRPL) is a subsidiary of Oil and Natural Gas Corporation (ONGC) and is one of the prominent players in the Indian refining industry. MRPL operates a state-of-the-art refinery located in Mangalore, Karnataka, with a focus on refining crude oil and producing a wide range of petroleum products. From motor spirit and diesel to aviation turbine fuel and specialty products, MRPL ensures the efficient processing and supply of petroleum products to meet the energy needs of the southern region of India. Committed to environmental sustainability and adhering to stringent quality standards, MRPL plays a vital role in supporting the country's energy security and economic development.",
    companyLink: "https://www.mrpl.co.in",
    button: "MRPL",
    companyLogo: "https://res.cloudinary.com/dcczhcvjg/image/upload/v1690971104/MRPL-Logo_h8tcrc.png",
      ...
      <>
        ...
        <div className="main-container ">
          {careerPageDetails.map(eachOne => (
            <ClientsPageCard cardData={eachOne} />
          ))}
        </div>
        <Footer />
        <StartPopup />
